...
const Cover = ({ image, heading, subHeading }) => {
    return (
        <div className="hero md:h-[500px] bg-cover" style={{ backgroundImage: `url(${image})` }}>
            <div className="hero-overlay bg-opacity-60"></div>
            <div className="hero-content w-full text-center text-neutral-content">
                <div style={{ backgroundColor: `rgba(21, 21, 21, 0.60)` }} className="sm:w-10/12 rounded-lg py-3 px-2 lg:py-20 lg:px-10 ">
