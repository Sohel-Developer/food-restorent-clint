...
const Navbar = () => {
    ...
    const navItem = <>
        ...
        <>
            {
                user?.email ? <li onClick={handleLogOut}><span className=" text-xl hover:text-white" >LogOut</span></li> :
    ...
    return (
        <div className="flex justify-center">
            <div className="navbar  bg-white shadow-md  text-black fixed z-10 ">
                <div className="navbar container">
                    ...
                    <div className="navbar-start">
                        ...
                        <a className="btn btn-ghost normal-case text-xl">Food Restorent</a>
                    </div>
